...
<body class="bg-dark text-white">
    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
            ...
            <h3 class="fw-bold"> Edit Record </h3>
            ...
            <div class="card-body p-4">
                <form action="edit-process.php" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 mb-3">
                            <label class="form-label">Complete Address</label>
                            <input type="text" id="mother_address" name="mother_address" class="form-control shadow-sm" value="<?= ($row['mother_ address'] ?? '') ?>">
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-4"> 
                        <button type="reset" class="btn btn-outline-light rounded-pill px-4 me-2">Clear</button>
                    <button type="submit" class="btn btn-outline-primary rounded-pill px-4" name="update">Update Record</button>
                </div>
